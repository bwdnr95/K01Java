...
class C extends B {
	...
	/*
	 따라서 C클래스로 객체를 생성하면 오버라이딩 된 메소드는
	 모두 가려지게 되어 C클래스에 정의된 메소드 하나만 남게 된다.
...
//		
		/*
		 ...
		 따라서 접근범위는 저네가 되므로 아래 3개의 호출문장은
		 모두 실행된다.
		 */
