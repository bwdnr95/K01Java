...
class BaseSpeaker extends Speaker {
	...
	/*
	 @Override : '어노테이션'이라고 부르고 오버라이딩 된 메소드에
	...
	public void showState() {
		/*
		 ...
		 특히, 오버라이딩 된 메소드를 호출 할 때 super가 없으면
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 ...
		 즉 아래 호출부분에서 speaker참조 변수를 통해서는 setBase()메소드는
		 호출할 수 없다. setBase()는 자식클래스에서 정의된 멤버 메소드이기
		 때문이다.
