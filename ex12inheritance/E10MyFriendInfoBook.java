...
class UnivFriend extends Friend {
	...
	public UnivFriend(String name, 
			String phone, String addr,String major) {
		super(name,phone,addr);
		this.major=major;
	}
	@Override
...
public class E10MyFriendInfoBook {
	...
	public static void main(String[] args) {
		...
		FriendInfoHandler handler = new FriendInfoHandler(100);/*
				연락처 정보를 저장할 객체배열의 크기를 10으로 초기화한다.
		*/
...
class FriendInfoHandler {
	...
	/*
	 친구의 정보를 출력하기 위한 멤버 메소드
	 1.친구정보를 추가할 때 High 혹은 Univ 객체가 배열에 저장된다.
	 2.입력시 모든 객체는 Friend로 자동 형변환되어 저장된다.
	 3.정보 출력시 배열의 입력된 객체 수 만큼 반복하면서 각 요소를 통해
	 	멤버메소드를 호출한다.
	 4.이때 오버라이딩 된 메소드를 통해 항상 해당 객체의 정보를 출력할 수 있다.
