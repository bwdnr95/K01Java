...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 자동형 변환 : 작은상자의 데이터를 큰 상자에 대입할 때 자동으로
		 	형 변환이 일어난다.
		 */
		byte b1 = 65;
		short s1;
		...
		/*
		 아래 코드는 자동형 변환은 아님. CPU는 int보다 작은 자료형을
		...
		/*
		 소수점 아래 부분이 버려지므로 데이트 손실이 있는 경우임. 따라서
		...
		/*
		 char과 int룰 연산하면 결과는 int형이므로 char형 변수에
		  결과를 대입하려면 반드시 명시적(강제)형 변환 후 진행해야 한다.
		 */
		char ch3 = 'A',ch4;
		int num4 = 2;
