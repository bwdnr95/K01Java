...
/*
 ...
 -main메소드에서 무시하기 위해 throws 하더라도 오류가 발생하므로
 	반드시 예외처리를 해줘야 한다.(무시할 수 없음)
 -예외발생시 jvm은 해당 예외클래스를 인스턴스화 해서 프로그램쪽으로
...
public class Ex01ExceptionBasic2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("당신의 10년후 나이는 :" + ageAfter10);//실행되지 않음
			...
			*/
			...
			int result = 10;
			try {
				result = result /0; //0으로는 숫자를 나눌 수없다.
			...
			System.out.println("=== ClassCastException 이후 ===");
