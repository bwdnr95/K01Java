...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		...
		/*
	 	...
	 	생각하자.
		 */
		Person annoyPerson = new Person("이말년") {
			
			/*
			 자식(익명클래스)개게에서 새롭게 확장한 멤버
		...
		annoyPerson.printInfo();//호출가능(오버라이딩 했으므로..)
		//annoyPerson.newMethod();//접근불가(확장한 멤버이므로..)
		/*
